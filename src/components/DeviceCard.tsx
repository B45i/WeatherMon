...
export const DeviceCard = ({ device }: { device: Device }) => {
  ...
  return (
    <div
      onClick={() => navigate(`${paths.DEVICES}/${device.id}`)}
      className="rounded-3xl card-bg overflow-hidden bg-background  text-white p-4 flex flex-col group cursor-pointer hover:scale-105 transition-all"
    >
